...
Nan::Persistent<v8::FunctionTemplate> SampleTileMeshWrap::constructor;

NAN_MODULE_INIT(SampleTileMeshWrap::Init) {
    Nan::HandleScope scope;
    Local<FunctionTemplate> t = Nan::New<FunctionTemplate>(New);
    t->InstanceTemplate()->SetInternalFieldCount(1);
    t->SetClassName(Nan::New("SampleTileMesh").ToLocalChecked());
    ...
    constructor.Reset(t);
    Nan::Set(target, Nan::New("SampleTileMesh").ToLocalChecked(), Nan::GetFunction(t).ToLocalChecked());
}

NAN_METHOD(SampleTileMeshWrap::New) {
    if (!info.IsConstructCall()) {
        return Nan::ThrowTypeError("Use the new operator to create new objects");
    }
    SampleTileMeshWrap *obj = new SampleTileMeshWrap();
...
NAN_METHOD(SampleTileMeshWrap::Load) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
    Nan::Utf8String filename(info[0]);
    dtFreeNavMesh(thisobj->m_navMesh);
    thisobj->m_navMesh = thisobj->loadAll(*filename);
    info.GetReturnValue().Set(thisobj->m_navQuery->init(thisobj->m_navMesh, 2048));
}

NAN_METHOD(SampleTileMeshWrap::AddOffMeshConnection) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
...
NAN_METHOD(SampleTileMeshWrap::DeleteOffMeshConnection) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
...
NAN_METHOD(SampleTileMeshWrap::GetOffMeshConnectionCount) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
    info.GetReturnValue().Set(thisobj->getInputGeom()->getOffMeshConnectionCount());
}

NAN_METHOD(SampleTileMeshWrap::Build) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
    info.GetReturnValue().Set(thisobj->handleBuild());
}

NAN_METHOD(SampleTileMeshWrap::FindPath) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
...
NAN_METHOD(SampleTileMeshWrap::FindNearestPoly) {
    SampleTileMeshWrap *thisobj = Nan::ObjectWrap::Unwrap<SampleTileMeshWrap>(info.This());
